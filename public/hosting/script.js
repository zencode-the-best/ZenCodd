...
async function loadWallet() {
  try {
    ...
    const sidebar = document.getElementById("sidebarWalletBalance");
        ...
        <div class="my-service">
          ...
          <div style="display:flex;align-items:center;gap:12px;">
            ...
            <button
              ...
              onclick="openService('${escapeAttribute(service.id)}','${escapeAttribute(type)}')">
              Otwórz →
            </button>
          </div>
        </div>
...
async function checkCEO() {
  const navigation = document.getElementById("ceoNavigation");
